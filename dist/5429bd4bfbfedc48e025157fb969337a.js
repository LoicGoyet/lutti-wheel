...
},{"object-assign":22,"fbjs/lib/emptyObject":25,"fbjs/lib/emptyFunction":26}],28:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":28,"fbjs/lib/warning":27,"./lib/ReactPropTypesSecret":24}],15:[function(require,module,exports) {
/** @license React v16.2.0
...
},{"object-assign":22,"fbjs/lib/emptyObject":25,"fbjs/lib/invariant":28,"fbjs/lib/warning":27,"fbjs/lib/emptyFunction":26,"prop-types/checkPropTypes":23}],10:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":14,"./cjs/react.development.js":15}],29:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./isTextNode":39}],32:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react":10,"fbjs/lib/ExecutionEnvironment":29,"object-assign":22,"fbjs/lib/emptyFunction":26,"fbjs/lib/EventListener":31,"fbjs/lib/getActiveElement":34,"fbjs/lib/shallowEqual":30,"fbjs/lib/containsNode":33,"fbjs/lib/focusNode":32,"fbjs/lib/emptyObject":25}],37:[function(require,module,exports) {
'use strict';
...
},{"./camelize":38}],17:[function(require,module,exports) {
/** @license React v16.2.0
...
},{"react":10,"fbjs/lib/invariant":28,"fbjs/lib/warning":27,"fbjs/lib/ExecutionEnvironment":29,"object-assign":22,"fbjs/lib/emptyFunction":26,"fbjs/lib/EventListener":31,"fbjs/lib/getActiveElement":34,"fbjs/lib/shallowEqual":30,"fbjs/lib/containsNode":33,"fbjs/lib/focusNode":32,"fbjs/lib/emptyObject":25,"prop-types/checkPropTypes":23,"fbjs/lib/hyphenateStyleName":36,"fbjs/lib/camelizeStyleName":35}],11:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":16,"./cjs/react-dom.development.js":17}],50:[function(require,module,exports) {
/*!
...
},{"isobject":50}],45:[function(require,module,exports) {
/*
 *          __        ___
 *    _____/ /___  __/ (_)____
 *   / ___/ __/ / / / / / ___/
...
},{"fbjs/lib/emptyFunction":26,"fbjs/lib/invariant":28,"fbjs/lib/warning":27,"object-assign":22,"./lib/ReactPropTypesSecret":24,"./checkPropTypes":23}],49:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/emptyFunction":26,"fbjs/lib/invariant":28,"./lib/ReactPropTypesSecret":24}],44:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./factoryWithTypeCheckers":48,"./factoryWithThrowingShims":49}],47:[function(require,module,exports) {
/**
...
},{"is-plain-object":43,"stylis":45,"stylis-rule-sheet":46,"react":10,"prop-types":44,"hoist-non-react-statics":47}],8:[function(require,module,exports) {
'use strict';
...
var WheelSection = function WheelSection(props) {
    var getTanFromDegrees = function getTanFromDegrees(degrees) {
        return Math.tan(degrees * Math.PI / 180);
    };

    var height = 200; // as px
    var vertexAngle = 360 / props.length; // as degree
    var halfBase = height / getTanFromDegrees(180 - vertexAngle / 2 - 90);
...
exports.default = WheelSection;


var Wrapper = _styledComponents2.default.div(_templateObject, function (props) {
    return props.height;
}, function (props) {
    return props.halfBase;
}, function (props) {
    return props.bgColor;
}, function (props) {
    return -(props.halfBase * 2 - 400) / 2;
}, function (props) {
    return props.index * props.vertexAngle;
}, function (props) {
    return props.disabled ? 0.15 : 1;
});

var Label = _styledComponents2.default.span(_templateObject2);
},{"react":10,"styled-components":42}],52:[function(require,module,exports) {
'use strict';
...
var _WheelSection = require('../WheelSection');

var _WheelSection2 = _interopRequireDefault(_WheelSection);
...
var Wheel = function (_React$Component) {
  ...
  function Wheel(props) {
    ...
    var _this = _possibleConstructorReturn(this, (Wheel.__proto__ || Object.getPrototypeOf(Wheel)).call(this, props));

    _this.shuffleSection = _this.shuffleSection.bind(_this);
    _this.turnsByShuffle = 10;

    _this.sections = _this.props.sections;
  ...
  _createClass(Wheel, [{
    key: 'shuffleSection',
    value: function shuffleSection() {
      var _this2 = this;

      var previousSelectedIndex = this.state.selectedIndex;
      var possibleSections = this.sections.filter(function (section, index) {
        return !_this2.state.selectedIndexes.includes(index);
      });

      var selectedSection = possibleSections[Math.floor(Math.random() * Math.floor(possibleSections.length))];
      var selectedIndex = this.sections.indexOf(selectedSection);

      var newRotation = this.state.rotation + this.turnsByShuffle * 360;
      var rotation = newRotation + (selectedIndex - previousSelectedIndex) * (360 / this.sections.length);

      this.setState({
        selectedIndex: selectedIndex,
        rotation: rotation,
        selectedIndexes: [].concat(_toConsumableArray(this.state.selectedIndexes), [selectedIndex])
      });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        Wrapper,
        null,
        this.state.selectedIndexes.length < this.sections.length && _react2.default.createElement(Trigger, { onClick: this.shuffleSection }),
        _react2.default.createElement(
          Circle,
          { turn: this.state.rotation * -1 },
          this.sections.map(function (section, index) {
            return _react2.default.createElement(_WheelSection2.default, {
              key: index,
              index: index,
              section: section,
              length: _this3.sections.length,
              disabled: _this3.state.selectedIndexes.includes(index) && _this3.state.selectedIndex !== index
            });
          })
        )
      );
...
var Trigger = _styledComponents2.default.button(_templateObject2);

var Circle = _styledComponents2.default.div(_templateObject3, function (props) {
  return props.turn;
});
},{"react":10,"styled-components":42,"../WheelSection":8}],6:[function(require,module,exports) {
'use strict';
    ...
    _createClass(App, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_Wheel2.default, { sections: sections })
            );
        }
    }]);
...
exports.default = App;
},{"react":10,"styled-components":42,"./components/Wheel":52}],4:[function(require,module,exports) {
"use strict";
...
},{"react":10,"react-dom":11,"./app":6}],57:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/5429bd4bfbfedc48e025157fb969337a.map